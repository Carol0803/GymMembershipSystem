...
Below are the process of operation performed by each function:
...
Then the integer variables will convert and combine to form a string date in YYYY/MM/DD format.
...
The expiry date will be returned in string form of YYYY/MM/DD format.
